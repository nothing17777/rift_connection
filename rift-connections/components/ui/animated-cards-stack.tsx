...
const cardVariants = cva("absolute will-change-transform", {
  variants: {
    variant: {
      dark: "flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-slate-800 bg-slate-900/90 p-6 backdrop-blur-md text-white shadow-xl shadow-blue-500/5",
      light: "flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-slate-700 bg-slate-900/90 p-6 backdrop-blur-md text-white shadow-xl shadow-indigo-500/5",
    },
  },
  defaultVariants: {
    variant: "dark",
